...
function bilgileriGetir(myIp) {
  return _axios.default.get("https://apis.ergineer.com/ipgeoapi/".concat(myIp)).then(function (res) {
    return res.data;
  }).then(function (data) {
    benimBilgiler = data;
  });
}
var sayfaYapici = function sayfaYapici(bilgiler) {
  ...
  var ip_adresi = document.createElement('h3');
  ...
  enlem.textContent = "Enlem: ".concat(bilgiler["enlem"], " Boylam: ").concat(bilgiler["boylam"]);
  var sehir = document.createElement('p');
  sehir.textContent = "\u015Eehir: ".concat(bilgiler["şehir"]);
  var saat_dilimi = document.createElement('p');
  saat_dilimi.textContent = "Saat dilimi: ".concat(bilgiler["saatdilimi"]);
  var para_birimi = document.createElement('p');
  para_birimi.textContent = "Para birimi: ".concat(bilgiler["parabirimi"]);
  var isp = document.createElement('p');
  isp.textContent = "ISP: ".concat(bilgiler["isp"]);
...
ipAdresimiAl().then(function () {
  bilgileriGetir(benimIP).then(function () {
